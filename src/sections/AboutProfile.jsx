    ...
    const careers = [
        {
            ...
            date: "2026. 3 ~ 2026. 9",
            headerSub: "네오플로(주) / 차장",
            bodyTitle: "담당업무 | UXUI 디자인 총괄업무",
            details: [
                "공공기관 및 기업 대상 SI 웹사이트 구축 프로젝트 디자인 전반 담당",
                "PC·모바일 반응형 웹 UI/UX 설계 및 화면 디자인",
                "메인·서브 페이지, 콘텐츠, 배너 등 웹 전반의 비주얼 디자인 제작",
                "Figma를 활용한 UI 시안 및 디자인 가이드 제작, 퍼블리셔·개발자 협업",
                "고객사 요구사항 및 피드백을 반영한 웹사이트 디자인 수정·개선",
                "프로젝트별 브랜드 아이덴티티를 고려한 컬러·타이포그래피·비주얼 방향성 수립",
                "경기도장애인체육회, AIZEN 등 공공기관·기업 웹 프로젝트 디자인 수행"
            ]
        },
        {
            type: 'career',
